        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form role="form" action="SurgeryUpdate" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        <input type="text" id="patientId" class="form-control" name="patientId" placeholder="Patient-ID or Email-ID">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-5">  
                                <div class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        <textarea class="form-control" rows="3" id="problemDescription" name="problemDescription"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        <textarea class="form-control" rows="3" id="solution" name="solution"></textarea>
                                    </div>
                                </div>
                            </div>
