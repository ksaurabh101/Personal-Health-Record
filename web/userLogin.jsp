                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        <input type="text" id="Id" class="form-control" name="userID" placeholder="User-ID or Email-ID">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <a href="forgotUserPassword.jsp" style="float: right"><p>forgot password</p></a>
                                <br>
                                <br/>
                                new User ? <a href="userRegistration.jsp">SignUP</a>
                                <%
                                    } else {
